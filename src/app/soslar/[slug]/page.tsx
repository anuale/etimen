...
export default async function SauceDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const cutNameMap: Record<string, string> = {
    "dana-bonfile": "Dana Bonfile",
    "dana-antrikot": "Dana Antrikot",
    "dana-riploin": "Dana Riploin",
    "dana-t-bone": "Dana T-Bone",
    "dana-brisket": "Dana Brisket",
    "dana-short-ribs": "Dana Short Ribs",
    "dana-chuck": "Dana Chuck",
    "dana-flank": "Dana Flank",
    "dana-sirloin": "Dana Sirloin",
    "dana-tritip": "Dana Tri-Tip",
    "dana-kıyma": "Dana Kıyma",
    "kuzu-pirzola": "Kuzu Pirzola",
    "kuzu-kol": "Kuzu Kol",
    "kuzu-but": "Kuzu But",
    "kuzu-kaburga": "Kuzu Kaburga",
    "kuzu-incik": "Kuzu İncik",
    "kuzu-rack": "Kuzu Rack",
    "tavuk-gogsu": "Tavuk Göğsü",
    "tavuk-but": "Tavuk But",
    "tavuk-kanat": "Tavuk Kanat",
    "tavuk-butun": "Bütün Tavuk",
    "tavuk-bonfile": "Tavuk Bonfile",
    "sigr-antrikot": "Sığır Antrikot",
    "sigr-kaburga": "Sığır Kaburga",
    "koyun-but": "Koyun But",
    "koyun-kol": "Koyun Kol",
    "keci-but": "Keçi But",
    "keci-kol": "Keçi Kol"
